...
function isColorTuple(possibleColorTuple: unknown): possibleColorTuple is ColorTuple {
  return Array.isArray(possibleColorTuple) && possibleColorTuple.length === 3
}
 ...
 */
export function deltaE(color1: string | ColorTuple, color2: string | ColorTuple, type: deltaValueType = 'rgb') {
  if (typeof color1 === 'string')
    color1 = getColorConvertion(type)(color1)

  if (typeof color2 === 'string')
    color2 = getColorConvertion(type)(color2)
